...
package io.joshworks.boot.loader.data;

import io.joshworks.boot.loader.ByteArrayStartsWith;
...
public class RandomAccessDataFileTests {
    ...
    public void setup() throws Exception {
        ...
        this.inputStream = this.file.getInputStream(RandomAccessData.ResourceAccess.PER_READ);
    }
    ...
    public void subsectionZeroLength() throws Exception {
        ...
        assertThat(subsection.getInputStream(RandomAccessData.ResourceAccess.PER_READ).read(),
                equalTo(-1));
    }
    ...
    public void subsection() throws Exception {
        ...
        assertThat(subsection.getInputStream(RandomAccessData.ResourceAccess.PER_READ).read(), equalTo(1));
    }

    @Test
    public void inputStreamReadPastSubsection() throws Exception {
        RandomAccessData subsection = this.file.getSubsection(1, 2);
        InputStream inputStream = subsection.getInputStream(RandomAccessData.ResourceAccess.PER_READ);
            ...
            results.add(executorService.submit(new Callable<Boolean>() {
                ...
                public Boolean call() throws Exception {
                    InputStream subsectionInputStream = RandomAccessDataFileTests.this.file
                            .getSubsection(0, 256)
                            .getInputStream(RandomAccessData.ResourceAccess.PER_READ);
                    byte[] b = new byte[256];
    ...
    public void close() throws Exception {
        this.file.getInputStream(RandomAccessData.ResourceAccess.PER_READ).read();
        this.file.close();
