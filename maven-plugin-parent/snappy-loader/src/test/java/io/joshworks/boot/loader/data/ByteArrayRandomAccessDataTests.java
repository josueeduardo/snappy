...
public class ByteArrayRandomAccessDataTests {
    ...
    public void testGetInputStream() throws Exception {
        ...
        assertThat(FileCopyUtils.copyToByteArray(
                data.getInputStream(RandomAccessData.ResourceAccess.PER_READ)), equalTo(bytes));
    ...
    public void testGetSubsection() throws Exception {
        ...
        assertThat(
                FileCopyUtils
                        .copyToByteArray(data.getInputStream(RandomAccessData.ResourceAccess.PER_READ)),
