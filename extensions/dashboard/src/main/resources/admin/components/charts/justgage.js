...
var JustGage = function(config) {
    ...
    if (config === null || config === undefined) {
        console.log('* justgage.js: Make sure to pass options to the constructor!');
        return false;
    }
    ...
    if (config.id !== null && config.id !== undefined) {
        ...
        if (!node) {
            console.log('* justgage.js: No element with id : %s found', config.id);
            return false;
        }
    } else if (config.parentNode !== null && config.parentNode !== undefined) {
        node = config.parentNode;
    } else {
        console.log('* justgage.js: Make sure to pass the existing element id or parentNode to the constructor.');
        return false;
    }
