                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box">
                                ...
                                <div class="box-content padded">
                                    <div class="row">
                                        <div class="col-md-4 separate-sections" style={{marginTop: '5px'}}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-content scrollable" style={{height: '552px', overflowY: 'auto'}}>
                                    ...
                                    <div class="box-section news with-icons">
                                        ...
                                        <div class="news-content">
                                            <div class="news-title"><a href="#">Twitter Bootstrap v3.0 is
                                                coming!</a></div>
                                            <div class="news-text">
                                                With 2.2.2 out the door, our attention has shifted almost entirely
                                                to the next major update to the project ...
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-section news with-icons">
                                        ...
                                        <div class="news-content">
                                            ...
                                            <div class="news-text">
                                                Rails 4.0 is still unfinished, but it is shaping up to become a
                                                great release ...
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="chat-box timeline">
                                ...
                                <li class="arrow-box-left gray">
                                    <div class="avatar"><img class="avatar-small"
      ...
      <span class="name">
        <span class="label label-green">COMMENT</span> <strong class="indent">Janine</strong> posted a comment on this task: <strong>Core Admin</strong>
                                ...
                                <li class="arrow-box-left gray">
                                    ...
                                    <div class="info">
      <span class="name">
        <span class="label label-blue">TASK</span> <strong class="indent">Alex</strong> completed this task: <strong
                                        ...
                                        <ul class="thumbnails padded">
                                            ...
                                            <li class="col-md-3">
                                                <a href="#" class="thumbnail">
                                                    <img src="http://placehold.it/240x100" alt=""></img>
                                                </a>
                                            </li>
